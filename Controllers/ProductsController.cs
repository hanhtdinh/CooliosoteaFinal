...
namespace CooliosoteaFinal.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(CooliosoteaContext context)
        {
            _context = context;
        }
        ...
        {
            var cooliosoteaContext = _context.Product.Include(p => p.Category);
            return View(await cooliosoteaContext.ToListAsync());
        }
